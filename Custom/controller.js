...
function startup() {
    var textSets = [
        ...
        ['RUNNING SYSTEMCHECK.exe...', 2000],
        ['SYSTEMCHECK RETURN: OK', 'RUNNING POWERCHECK.exe', 2000],
        ['POWERCHECK RETURN OK', '1000W OK', 1000],
        ['REMOTE NETWORK OK', 'RUNNING SYSCHKLEGACY.exe', 1000],
        ...
        ['SYSTEM CHECK...', 'CONTROLLER: Ok', 'DATA: Ok', 'SIGNS: CHECKING...', 2000],
