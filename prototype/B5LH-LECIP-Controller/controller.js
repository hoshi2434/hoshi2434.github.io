...
function firmware() {
    ...
    document.getElementById('keypad-set').addEventListener('click', registerKeyPress.bind(null, 'ENT'));
    document.getElementById('keypad-bs').addEventListener('click', registerKeyPress.bind(null, 'CLR'));
    document.getElementById('keypad-f3').addEventListener('click', registerKeyPress.bind(null, 'F3'));
    document.getElementById('keypad-dir').addEventListener('click', registerKeyPress.bind(null, 'F4'));
    document.getElementById('keypad-right').addEventListener('click', registerKeyPress.bind(null, 'UP'));
    document.getElementById('keypad-left').addEventListener('click', registerKeyPress.bind(null, 'DOWN'));
    setCode('1111', 1);
