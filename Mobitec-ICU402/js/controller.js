...
window.addEventListener('load', () => {
    document.getElementById('button-f1').addEventListener('click', onUpPressed);
    document.getElementById('button-f2').addEventListener('click', onTickPressed);
    document.getElementById('button-f3').addEventListener('click', onCrossPressed);
    document.getElementById('button-f4').addEventListener('click', onDownPressed);
    document.getElementById('button-f5').addEventListener('click', onF1Pressed);
    document.getElementById('button-home').addEventListener('click', onF1Pressed);
    ...
    document.getElementById('button-no').addEventListener('click', onF1Pressed);
